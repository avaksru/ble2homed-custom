...
exports.mqtt_prefix = "homed";

exports.scanTimeout = 0;
exports.scanInterval = 0;
exports.retain;
...
exports.init = function () {
  ...
  if (fs.existsSync(config_filename)) {
    ...
    if (json.scanTimeout)
      exports.scanTimeout = json.scanTimeout;
    if (json.scanInterval)
      exports.scanInterval = json.scanInterval;
    if (json.retain)
      exports.retain = json.retain;
    ...
    if (json.hasOwnProperty("homed"))
      exports.homed = json.homed;
